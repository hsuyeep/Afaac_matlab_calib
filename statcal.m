%function [cal, sigmahat, Sigman] = statcal(acc, t_obs, freq, pos, srcsel, normal, restriction, maxrestriction, uvflag)
function [cal, sigmas, Sigman] = statcal(acc, t_obs, freq, pos, srcsel, normal, restriction, maxrestriction, uvflag)
