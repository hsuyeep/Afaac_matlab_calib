...
%			 in_sig); 
%	fname = sprintf ('%s_uni_intap_uvoff10m_%f', arrayconf, in_sig);
%	tparm.type = 'gaussian';
%	tparm.pa(1) = in_sig;  
%	tparm.pa(2) = in_sig; 
...
%% INNER and OUTER Taper, over a favourable range.
