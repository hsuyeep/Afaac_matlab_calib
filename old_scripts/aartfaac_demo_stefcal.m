...
[cal, sigmas, Sigman] = statcal_stefcal (acc, tobs, freq, posITRF, srcsel, normal, 10, 60, eye(Nelem));
...
[ghat, sigmas2, Sigman2] = cal_ext_stefcal(acc, A, sigmas(sel), squeeze(abs(Sigman)) > 0);
cal2 = (1 ./ ghat)';
